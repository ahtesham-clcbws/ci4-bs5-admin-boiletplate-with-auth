...
<head>
    <!-- <script src="/assets/libraries/color-modes.js"></script> -->
...
<body class="bg-light">
    ...
    <div class="container-fluid">
        <div class="row">
            ...
            <main class="col-md-9 ms-sm-auto col-lg-10 p-2 mb-3 pe-md-3" id="mainContent">
                <div class="evryCardHaveSameClasses">
